             ...
             <div class="row">
                 <div class="col-xl-6">
                    <div class="hero-caption">
                        ...
                        cursus, mi quis viverra ornare.</p>
                        <!-- Hero Btn -->
                        <a href="view/services.php" class="btn"  data-animation="fadeInLeft" data-delay=".8s" >Our Services</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="single-offers mb-50 wow fadeInUp" data-wow-delay=".2s" >
                    ...
                    <div class="offers-cap">
                        <span>1</span>
                        <h3><a href="view/services.php">Tailor Sweing</a></h3>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="single-offers mb-50 wow fadeInUp" data-wow-delay=".4s">
                    ...
                    <div class="offers-cap">
                        <span>2</span>
                        <h3><a href="view/services.php">Mesurement</a></h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="single-offers mb-50 wow fadeInUp" data-wow-delay=".6s">
                    ...
                    <div class="offers-cap">
                        <span>3</span>
                        <h3><a href="view/services.php">Ready-made</a></h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique.</p>
                    </div>
                </div>
            </div>
...
<footer>
    <div class="footer-wrapper section-bg2 pl-100"  data-background="assets/img/gallery/footer-bg.png" style="height: 100% ;">
        <!-- Footer Start-->
