...
<div class="clients-area section-padding40">
    <div class="container">
        <div class="single-offers mb-50 wow fadeInUp" data-wow-delay=".1s" >
            <div class="section-top-border">
                <h3 class="mb-30">Tailor Sweing</h3>
                <div class="row">
                    <div class="col-md-3">
                        <img src="assets/img/gallery/offers1.png" alt="" class="img-fluid">
                    </div>
        ...
        <div class="single-offers mb-50 wow fadeInUp" data-wow-delay=".1s" >
            <div class="section-top-border">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <img src="assets/img/gallery/offers2.png" alt="" class="img-fluid">
                    </div>
                    <div class="col-md-9 mt-sm-20">
                        <p>Recently, the US Federal government banned online casinos from operating in America by making
                            it illegal to
        ...
        <div class="single-offers mb-50 wow fadeInUp" data-wow-delay=".1s" >
            <div class="section-top-border">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <img src="assets/img/gallery/offers3.png" alt="" class="img-fluid">
                    </div>
                    <div class="col-md-9 mt-sm-20">
                        <p>Recently, the US Federal government banned online casinos from operating in America by making
                                    it illegal to
    ...
    <div class="container">
        <div class="video-wrap position-relative">
            ...
            <div class="video-icon" >
                <a class="popup-video btn-icon" href="https://www.youtube.com/watch?v=DTcEKxsqb-Y"><i class="fas fa-play"></i></a>
            </div>
        </div>
    </div>
</div>
