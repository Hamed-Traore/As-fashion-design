...
//     $key=$_POST['keyword'];
//     $search_result= search_user_ctr($key);
//     echo "<div class='container-xxl flex-grow-1 container-p-y'>
//     <h4 class='fw-bold py-3 mb-4'><span class='text-muted fw-light'>Tables /</span> List of all the Customers</h4>
...
//           <tr>
//             <td><i class='fab fa-angular fa-lg text-danger me-3'></i> <strong>hhhhhh</strong></td>
//             <td>ffffff</td>
//             <td>ggggg</td>
//             <td>yyyyy</td>
//             <td><span class='badge bg-label-primary me-1'>bbbbb</span></td>
//             <td>
//               <div class='col'>
...
>
  ...
  <body>
    <!-- Layout wrapper -->
    <div class="layout-wrapper layout-content-navbar" id="up">
          ...
          <nav class="layout-navbar container-xxl navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme"
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
              ...
              <div class="navbar-nav align-items-center">
                ...
                <button type="submit" name="search_user"><i class="bx bx-search fs-4 lh-0"></i></button>
                  <input
                    type="text"
                    name="keyword"
                ...
                <table class="table card-table">
                  ...
                  <tbody class="table-border-bottom-0">
                    ...
                    <tr>
                      ...
                      <td>'.$user['country'].'</td>
                      <td><span class="badge bg-label-primary me-1">'.$user['date_of_birth'].'</span></td>
                      <td>
                        <div class="col">
                          <a class="dropdown-item" href="javascript:void(0);"><i class="bx bx-edit-alt me-1"></i> Edit</a>
